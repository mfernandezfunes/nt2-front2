  ...
  <v-container>
    <v-layout justify-center>
      <v-flex xs12 sm10 md8>
        <material-card color="primary" title="Vue Material Dashboard PRO"
          ...
          <table class="v-table">
            ...
            <tbody class="text-xs-center">
              ...
              <tr>
                <th />
                <td>
                  <v-btn class="subheading white--text font-weight-light" round large color="grey" disabled>Current
                    Version</v-btn>
                </td>
                <td>
                  <v-btn class="subheading white--text font-weight-light" round large color="cyan">Upgrade to Pro
                  </v-btn>
                </td>
              </tr>
            </tbody>
